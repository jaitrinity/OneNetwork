...
export class CheckpointComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.mandatoryList = [{"paramCode":"0","paramDesc":"Non Mandatory"},
                          {"paramCode":"1","paramDesc":"Mandatory"}
                      ];

    this.editableList = [{"paramCode":"0","paramDesc":"Non Editable"},
                          {"paramCode":"1","paramDesc":"Editable"}
                      ]
  ...
  onSelectOrDeselectInputType(item){
    ...
    this.isAllOk = false;
    if(item.paramCode == 1){
      this.valueHTML = "Restricted Character";
      this.sizeHTML = "Character Limit";
      this.isShowValueTxt = true;

      this.valuePlaceholder = "Enter can not use charactor";
      this.optionValue = ",&()^%$#@!-=";
    ...
    // radio
      ...
      this.valueHTML = "Display On"
      this.isShowValueSelect = true;
    }
    else if(item.paramCode == 17){
      this.sizeHTML = "Caption Position";
      this.isShowSizeSelect = true;
    }
    ...
    if(item.paramCode == 1 || item.paramCode == 2 || item.paramCode == 3.0 || item.paramCode == 3.1 || item.paramCode == 4.0 || item.paramCode == 4.1 ||
      ...
      this.activeList = [{"paramCode":"0","paramDesc":"Not Active"},
                          {"paramCode":"1","paramDesc":"Active"}
                      ]
    }
    else if(item.paramCode == 5){
      this.activeList = [{"paramCode":"0","paramDesc":"No"},
                          {"paramCode":"1","paramDesc":"Yes"}
                      ]
    }
    else if(item.paramCode == 9){
  ...
  if(item.paramCode == 5){
    ...
    this.valueList = tempValueList;
      ...
      this.valueList = [{"paramCode":"0","paramDesc":"Display on browser"},
  ...
  validateData(inputTypeId) : any{
    ...
    else if((inputTypeId == "1" || inputTypeId == "2" || inputTypeId == "3.1" || inputTypeId == "11" || inputTypeId == "12" || inputTypeId == "21") 
      && this.optionValue == ""){
    ...
    //   return false;
    // }
    else if((inputTypeId == "5" || inputTypeId == "7" || inputTypeId == "16") && this.selectedValueList.length == 0){
      this.toastr.warning("please select "+this.valueHTML,"Alert !",{timeOut : this.alertFadeoutTime});
      return false;
    }
    else if((inputTypeId == "8" || inputTypeId == "9") && this.correct == ""){
    ...
    else if((inputTypeId == "5" || inputTypeId == "7" || inputTypeId == "8" || inputTypeId == "9" || inputTypeId == "15" || inputTypeId == "17") && this.selectedSizeList.length == 0){
    ...
    else if((inputTypeId == "1" || inputTypeId == "2" || inputTypeId == "3.0" || inputTypeId == "3.1" || inputTypeId == "4" || 
    inputTypeId == "5" || inputTypeId == "6" || inputTypeId == "7" || inputTypeId == "8" || inputTypeId == "9") && this.selectedActiveList.length == 0){
  ...
  submitCheckpointData(type){
    ...
    if(inputTypeId == "4" || inputTypeId == "7" || inputTypeId == "8" || inputTypeId == "9" || inputTypeId == "10"
